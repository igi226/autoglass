<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('admin.index') }}">{{ env('APP_NAME')[0] }}</a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{ route('admin.product.index') }}"><i class="fas fa-dolly-flatbed"></i>
                    <span>Part Inventory</span></a></li>
            <li><a class="nav-link" href="{{ route('admin.product.request') }}"><i class="fas fa-upload"></i>
                    <span>Product Requests</span></a></li>
            <li class="menu-header">User management</li>
            <li><a class="nav-link" href="{{ route('admin.user.index') }}"><i class="fas fa-user"></i>
                    <span>User Management</span></a></li>
            <li><a class="nav-link" href="{{ route('admin.user.requests') }}"><i class="fas fa-user-check"></i>
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="{{ route('admin.password.change') }}" class="btn btn-primary btn-lg btn-block btn-icon-split">
